<?php
	...
	foreach(Config::get('locales.languages') as $language)
	{
		...
		Route::group(['prefix' => $prefix], function()
		{
            ...
            Route::get('auction/{id}', 'PageController@tender');
            ...
            Route::get('auction/{id}/print/{type}/{print}', 'PrintController@one')->where('print', '(pdf|html)');
            Route::get('auction/{id}/print/{type}/{print}/{lot_id?}', 'PrintController@one')->where('print', '(pdf|html)');
    ...
    Route::get('aim', 'PageController@aim');
    Route::get('team/{slug}', 'PageController@team');
