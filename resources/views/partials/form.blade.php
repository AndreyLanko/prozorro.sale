		...
		<div class="container">		
			...
			<div class="search-form--category">
				<ul class="nav navbar-nav inline-navbar">
					<li><a @if ($search_type=='tender') class="active"@endif href="{{href('auction/search')}}">{{trans('form.tenders')}}</a></li>
...
<script id="block-aid" type="text/x-jquery-tmpl" data-suggest-name="{{trans('form.auctionid')}}" data-button-name="{{trans('form.auctionid')}}">
<div class="block block-aid"><span class="block-key">{{trans('form.auctionid')}}</span><input type="text" value="{value}"></div>
</script>
<script id="block-cav" type="text/x-jquery-tmpl" data-suggest-name="{{trans('form.cav')}}" data-button-name="{{trans('form.cav')}}">
<div class="block block-cav"><button class="none">{{trans('form.choose')}}&nbsp;(<span></span>)</button><span class="block-key">{{trans('form.cav')}}</span><select /></div>
</script>
...
<script id="block-proc_type" type="text/x-jquery-tmpl" data-suggest-name="{{trans('form.proc_type')}}" data-button-name="{{trans('form.proc_type')}}">
<div class="block block-proc_type"><span class="block-key">{{trans('form.proc_type')}}</span><select /></div>
</script>
